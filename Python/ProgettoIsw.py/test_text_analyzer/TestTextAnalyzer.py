...
class TestTextAnalyzer(unittest.TestCase):
    ...
    def test_text_analyzer_remove_word_with_single_character(self):
        expected = ['love', 'baloons', 'red']
        self.text_analyzer.text = ['i', 'love', 'baloons', 'a', 'e', 'i', 'o', 'u', 'red']
        self.text_analyzer.remove_word_with_single_charatcter()
